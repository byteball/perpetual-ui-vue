export const propertyTips = {
  ...
  multiplier: "Multiplier applied to the oracle's price. It is used to account for decimals and return the price of the smallest indivisible unit of the asset.",
  ...
  adjustment_period: "The time it takes for the asset's price to automatcally correct to the target price",
  presale_period: "Presale duration in days for newly launched assets",
  auction_price_halving_period: "Auction price halving period for newly launched pre-IPO assets",
  token_share_threshold: "If a newly launched asset on a presale reaches this share of the total assets, the presale ends prematurely.",
  min_s0_share: "Minimum share of the governance asset among all assets. If it drops below this level, the prices of all other assets are automatically decreased to protect the share of the governance asset.",
  price_aa: "An autonomous agent used to obtain the target asset price", // используется в trading блоке в Governance/manage(GM)
  drift_rate: "If non-zero, the asset depreciates at this rate per year and the value is moved to governance asset holders",
